...
run_workunit_experiment:
	...
	python3 ./plot_results.py ./results_master_worker_hosts_${XP2_NUM_HOSTS}_${XP2_NUM_HOSTS}_cores_${XP2_NUM_CORES_PER_HOST}_${XP2_NUM_CORES_PER_HOST}_workunits_${XP2_MIN_NUM_WORKUNITS}_${XP2_MAX_NUM_WORKUNITS}.pickled ./results_master_worker_hosts_${XP2_NUM_HOSTS}_${XP2_NUM_WORKUNITS}_cores_${XP2_NUM_CORES_PER_HOST}_${XP2_NUM_CORES_PER_HOST}_workunits_${XP2_MIN_NUM_WORKUNITS}_${XP2_MAX_NUM_WORKUNITS}.pdf 1> ./results_master_worker_hosts_${XP2_NUM_HOSTS}_${XP2_NUM_HOSTS}_cores_${XP2_NUM_CORES_PER_HOST}_${XP2_NUM_CORES_PER_HOST}_workunits_${XP2_MIN_NUM_WORKUNITS}_${XP2_MAX_NUM_WORKUNITS}.txt
...
run_core_experiment:
	...
	cp /tmp/results.pickled ./results_master_worker_hosts_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_cores_${XP3_MIN_NUM_CORES_PER_HOST}_${XP3_MAX_NUM_CORES_PER_HOST}_workunits_${XP3_NUM_WORKUNITS}_${XP3_NUM_WORKUNITS}.pickled
	python3 ./plot_results.py ./results_master_worker_hosts_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_cores_${XP3_MIN_NUM_CORES_PER_HOST}_${XP3_MAX_NUM_CORES_PER_HOST}_workunits_${XP3_NUM_WORKUNITS}_${XP3_NUM_WORKUNITS}.pickled ./results_master_worker_hosts_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_${XP3_NUM_HOSTS}_cores_${XP3_MIN_NUM_CORES_PER_HOST}_${XP3_MAX_NUM_CORES_PER_HOST}_workunits_${XP3_NUM_WORKUNITS}_${XP3_NUM_WORKUNITS}.pdf 1> ./results_master_worker_hosts_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_${XP3_NUM_HOSTS_FOR_NUM_CORES_EXPERIMENTS}_cores_${XP3_MIN_NUM_CORES_PER_HOST}_${XP3_MAX_NUM_CORES_PER_HOST}_workunits_${XP3_NUM_WORKUNITS}_${XP3_NUM_WORKUNITS}.txt
