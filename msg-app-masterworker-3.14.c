...
void create_platform_file(char *filepath, 
  ...
  fprintf(pf, "    <prop id=\"watt_per_state\" value=\"100.0:120.0:200.0, 93.0:115.0:170.0, 90.0:110.0:150.0\" /> <prop id=\"watt_off\" value=\"10\" />\n");
  fprintf(pf, "  </host>\n");
  ...
  for (int i=0; i < num_hosts; i++) { 
    ...
    fprintf(pf, "  <host id=\"WorkerHost-%d\" speed=\"%.2lfMf,%.2lfMf,%.2lfMf\" core=\"%d\">\n", i, 
		     core_speed, core_speed * 0.5, core_speed * 0.2, num_cores_per_host);
    fprintf(pf, "    <prop id=\"watt_per_state\" value=\"100.0:120.0:200.0, 93.0:115.0:170.0, 90.0:110.0:150.0\" /> <prop id=\"watt_off\" value=\"10\" />\n");
    fprintf(pf, "  </host>\n");
  }
